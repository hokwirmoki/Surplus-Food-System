    ...
    try {
        ...
        await db.query(`
            CREATE TABLE IF NOT EXISTS food_items (
                ...
                emission_factor_kg_co2e_per_kg NUMERIC(10,2),
                co2e_saved_kg NUMERIC(10,2),
        ...
        await db.query(`
            ...
            ADD COLUMN IF NOT EXISTS quantity_amount NUMERIC(10,2),
            ADD COLUMN IF NOT EXISTS quantity_unit TEXT,
            ADD COLUMN IF NOT EXISTS estimated_unit_weight_kg NUMERIC(10,3),
            ADD COLUMN IF NOT EXISTS estimated_weight_kg NUMERIC(10,2),
            ADD COLUMN IF NOT EXISTS emission_factor_kg_co2e_per_kg NUMERIC(10,2),
            ADD COLUMN IF NOT EXISTS co2e_saved_kg NUMERIC(10,2),
            ADD COLUMN IF NOT EXISTS impact_confidence TEXT,
            ADD COLUMN IF NOT EXISTS impact_method TEXT,
